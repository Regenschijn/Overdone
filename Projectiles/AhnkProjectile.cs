...
namespace Overdone.Projectiles {
    public class AhnkProjectile : ModProjectile {
        ...
        public override bool OnTileCollide( Vector2 velocityChange ) {
            Projectile.NewProjectile( projectile.position.X, projectile.position.Y, MathHelper.Lerp( -1f, 1f, (float)Main.rand.NextDouble() ), MathHelper.Lerp( -1f, 1f, (float)Main.rand.NextDouble() ), mod.ProjectileType( "AhnkTinyProjectile" ), 25, projectile.knockBack, Main.myPlayer );
